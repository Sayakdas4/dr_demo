        ...
        {!showPassword ? (
          ...
          >
            ...
            />
                      ...
                      <div x-data="{ checkboxToggle: false }">
                        ...
                        >
                          <div className="relative">
                            ...
                            <input
                              type="checkbox"
                              className="w-5 h-5 appearance-none cursor-pointer dark:border-gray-700 border border-gray-300 checked:border-transparent rounded-md checked:bg-brand-500 disabled:opacity-60 mr-2"
                              id="remember-me"
                            />
                          </div>
                          Keep me logged in
                    ...
                    {/* Button */}
                    <div>
                      <button className="flex items-center justify-center w-full px-4 py-3 text-sm font-medium text-white transition rounded-4xl bg-brand-500 custom-shadow border border-white hover:bg-brand-600">
                        Sign In
                      </button>
                    </div>
                  </div>
          ...
          <div className="relative items-center justify-center  flex z-1">
            ...
            <div className="flex flex-col items-center max-w-xs">
              <a className="block mb-4">
                <img src="/images/logo/drl_logo_white.svg" alt="Logo" />
              </a>
