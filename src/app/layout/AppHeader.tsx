...
const AppHeader: React.FC = () => {
  ...
  const generateBreadcrumbs = () => {
    ...
    const breadcrumbs = asPathNestedRoutes.map((subpath, idx) => {
      ...
      const title = subpath.replace(/-/g, ' ').replace(/\b\w/g, l => l.toUpperCase());
      return { href, title };
    });

    // Add home breadcrumb
    return [{ href: '/admin/dashboard', title: 'Home' }, ...breadcrumbs];
  };
      ...
      <div className="flex flex-col items-center justify-between grow lg:flex-row lg:px-6">
        ...
        <div className="hidden items-center justify-between w-full gap-4 px-5 py-4 lg:flex shadow-theme-md lg:justify-end lg:px-0 lg:shadow-none">
          ...
          <div className="relative inline-block text-left" ref={dropdownRef}>
            ...
            >
              <span className="mr-3 overflow-hidden rounded-full h-11 w-11">
                <img
                  ...
                  data-nimg={1}
                  style={{ color: "transparent" }}
                  srcSet="/_next/image?url=%2Fimages%2Fuser%2Fowner.jpg&w=48&q=75 1x, /_next/image?url=%2Fimages%2Fuser%2Fowner.jpg&w=96&q=75 2x"
                  src="/_next/image?url=%2Fimages%2Fuser%2Fowner.jpg&w=96&q=75"
                />
              </span>
            ...
            {isOpen && (
              <div className="profile-details absolute z-40 shadow-theme-lg dark:bg-gray-dark right-0 mt-[17px] w-[260px] flex-col rounded-2xl border border-gray-200 bg-white p-3 shadow-theme-lg dark:border-gray-800 dark:bg-gray-dark">
                ...
                <ul className="flex flex-col gap-1 pt-4 pb-3 border-b border-gray-200 dark:border-gray-800">
                  <li>
                    <a
                      className="w-full text-left text-sm  flex items-center gap-3 px-3 py-2 font-medium text-gray-700 rounded-lg group text-theme-sm hover:bg-gray-100 hover:text-gray-700 dark:text-gray-400 dark:hover:bg-white/5 dark:hover:text-gray-300"
                      href="/profile"
                    >
                      <svg
